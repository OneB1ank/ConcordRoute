...
func ProvideAdminHandlers(
	...
	clashProxyHandler *admin.ClashProxyHandler,
	...
	codexAttestationCollectorHandler *admin.CodexAttestationCollectorHandler,
	...
	return &AdminHandlers{
		...
		CodexAttestationCollector: codexAttestationCollectorHandler,
...
// ProvideCodexAttestationCollectorHandler 注入与网关共享的 app-server
// 证明采集器管理处理器。
...
var ProviderSet = wire.NewSet(
	...
	ProvideCodexAttestationCollectorHandler,
