...
func TestPairCodexClientIdentity(t *testing.T) {
	tests := []struct {
		...
		{name: "UA 含 CRLF 注入拒绝", ua: "codex-tui/1.0.0\r\nX-Injected: 1", wantOK: false},
		{name: "UA 含 NUL 控制字节拒绝", ua: "codex-tui/1.0.0\x00", wantOK: false},
		{name: "UA 含垂直控制字节拒绝", ua: "codex-tui/1.0.0\x0b", wantOK: false},
...
func TestCodexUserAgentVersionHelpers(t *testing.T) {
	...
	const desktopUA = "Codex Desktop/0.144.5 (Windows 10.0.26200; x86_64) dumb (Codex Desktop; 26.825.41651)"
	...
	require.Equal(t,
		"Codex Desktop/0.145.0 (Windows 10.0.26200; x86_64) dumb (Codex Desktop; 26.825.41651)",
