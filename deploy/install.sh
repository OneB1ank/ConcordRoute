...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/OneB1ank/ConcordRoute/cockpit-sync/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="OneB1ank/ConcordRoute"
...
Documentation=https://github.com/OneB1ank/ConcordRoute
