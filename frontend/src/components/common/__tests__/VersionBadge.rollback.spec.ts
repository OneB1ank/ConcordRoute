...
describe('VersionBadge 回退目标', () => {
  it('手动命令始终指向 ConcordRoute 仓库与 GHCR 镜像', () => {
    expect(source).toContain("const GITHUB_REPO = 'OneB1ank/ConcordRoute'")
    expect(source).toContain("const DOCKER_IMAGE = 'ghcr.io/oneb1ank/concordroute'")
