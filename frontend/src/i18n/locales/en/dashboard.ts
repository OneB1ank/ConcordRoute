...
// Usage
  usage: {
    ...
    codexTurnStateHint: 'Length of the trimmed x-codex-turn-state response header; passive upstream observation only, with no plan, full, or degraded classification.',
    codexTurnStateAbsent: 'state · absent',
    codexTurnStatePresent: 'state · {bytes} B',
