...
// Usage
  usage: {
    ...
    upstreamStatusHint: 'Observed final upstream HTTP status; state shows only response-header length without plan or degradation classification. This is not the client-facing status.',
    ...
    codexTurnStateHint: 'Byte length of the trimmed upstream x-codex-turn-state response header. This does not indicate whether the request carried state or a plugin modified it. Absent refers only to the response; length does not classify plans, full service, or degradation.',
    codexTurnStateAbsent: 'Response state · absent',
    codexTurnStatePresent: 'Response state · {bytes} B',
