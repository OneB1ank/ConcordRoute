...
// Usage
  usage: {
    ...
    upstreamStatusHint: 'Observed final upstream HTTP status, not the client-facing status. Codes including 200, 290, 292 and 312 do not indicate model capability, downgrade or session health.',
    ...
    codexTurnStateHint: 'Byte length of the response x-codex-turn-state header after trimming outer whitespace. Not an HTTP status, expiry or device attestation. The opaque value is not stored.',
