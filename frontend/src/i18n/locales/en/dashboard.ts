...
// API Keys
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description: 'Configure Grok Build, Claude Code, Codex, or OpenCode to send requests through your ConcordRoute Grok group.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your ConcordRoute Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your ConcordRoute Grok group.',
        ...
        codexNote: 'Save config.toml under ~/.codex and set CONCORDROUTE_API_KEY before starting Codex.',
        codexNoteWindows: 'Save config.toml under %USERPROFILE%\\.codex and set CONCORDROUTE_API_KEY in PowerShell before starting Codex.',
      },
      opencode: {
...
// Usage
  usage: {
    ...
    upstreamStatusHint: 'Observed final upstream HTTP status. Healthy and degraded Codex states normally both use HTTP 200; the Turn-State length below is the actual classifier. This is not the client-facing status.',
    upstreamStatusMissingHint: 'Not captured for historical records, WebSockets without a per-request HTTP response, or unsupported paths. Never filled with an assumed 200.',
    codexTurnStateHint: 'Length of the response x-codex-turn-state string after trimming outer whitespace. Pro uses 292 for full and 312 for degraded; Team uses 332 for full and 356 for degraded. Only the length is stored.',
    codexTurnStateAbsent: 'state · absent',
    codexTurnStateFull: 'state · {bytes} B · {plan} full',
    codexTurnStateDegraded: 'state · {bytes} B · {plan} degraded',
    codexTurnStateUnknown: 'state · {bytes} B · unknown',
    codexTurnStateRequestModeHint: 'Request-side action: injected means this request used a cached full State; acquire means it used the State acquisition phase; disabled means injection was off; not recorded means a historical or unsupported path.',
    codexTurnStateRequestInjected: 'request · injected',
    codexTurnStateRequestAcquire: 'request · acquire',
    codexTurnStateRequestDisabled: 'request · disabled',
    codexTurnStateRequestNotRecorded: 'request · not recorded',
    codexTurnStateRequestUnknown: 'request · unknown',
    ...
    latencyFirstTokenNotRecordedHint: 'No first-event sample was recorded: a legacy sample, an interrupted stream, or no output matching the metric definition. This does not mean zero latency.',
