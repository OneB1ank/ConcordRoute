...
// Usage
  usage: {
    ...
    latencyFirstTokenNotRecordedHint: 'First-content timing is missing: a legacy sample, an interrupted stream, or no recognized content. This does not mean zero latency.',
