    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          description: 'V2 passive aggregation is the default; V1 active probes can be selected explicitly. The modes are mutually exclusive, and disabling stops background jobs and hides the user entry.',
...
// TLS Fingerprint Profiles
    tlsFingerprintProfiles: {
      ...
      form: {
        ...
        yamlParsed: 'YAML parsed successfully, fields auto-filled',
        yamlParseFailed: 'Failed to parse YAML: name field not found',
        yamlAlpnInvalid: 'YAML alpn_protocols must be an array (for example ["h2", "http/1.1"]), null, or empty',
        name: 'Profile Name',
        ...
        rustlsNativeOrder: 'Enable native rustls ordering',
        rustlsNativeOrderHint: 'Use rustls 0.23.36 ordering with a fresh seed per connection, reusing that seed when a handshake retry adds Cookie. When disabled, preserve template order. UA and application sessions are unchanged. Disable GREASE. This does not replace the TLS backend.',
        rustlsNativeOrderConflict: 'Disable GREASE and remove GREASE extensions. Manual PSK(41), Cookie(44), and real ECH outer_extensions(64768) are not supported in this mode.',
        ...
        alpnProtocolsHint: 'Comma-separated, e.g. h2, http/1.1. For a capture without ALPN, leave this empty and retain its custom extension list without 0x0010. An empty extension list uses the default handshake configuration.',
        alpnExtensionConflict: 'ALPN protocols are set, but the custom extension list lacks 0x0010 (16). Choose a repair before saving: adding the extension changes the handshake; clear the protocols to preserve a capture without ALPN.',
        addAlpnExtension: 'Add ALPN extension 16',
        clearAlpnProtocols: 'Clear protocols, keep no ALPN',
    ...
    codexAttestationCollector: {
      title: 'Codex app-server Attestation Collector',
      description: 'Capture capability negotiation and opaque proof summaries from a real Windows Codex client without storing proof material.',
      scopeTitle: 'Scope',
      scopeAttestation: 'Attestation: initialize / generate summaries',
      scopeIdentity: 'Identity: follows the account Codex convergence policy',
      scopeTransport: 'Transport: follows the account TLS profile/router',
      running: 'Running',
      stopped: 'Stopped',
      start: 'Start',
      stop: 'Stop',
      ttl: 'Session TTL',
      maxRecords: 'Per-session limit',
      activeSessions: 'Active sessions',
      createSession: 'Create capture session',
      refresh: 'Refresh captures',
      token: 'Collector token',
      expiresAt: 'Expires at',
      bridgeQuery: 'app-server query parameter',
      bridgeEndpoint: 'WebSocket endpoint (HTTP/1.1 Upgrade)',
      headerHint: 'Or use handshake header',
      copyEndpoint: 'Copy endpoint',
      deleteSession: 'Delete session',
      sessionDeleted: 'Capture session deleted',
      deleteSessionFailed: 'Failed to delete capture session',
      captures: 'Captures',
      noCaptures: 'No captures yet. Attach collector_token to the app-server WebSocket (HTTP/1.1 Upgrade) and run the client.',
      client: 'Client',
      connection: 'Connection',
      session: 'Session',
      proof: 'Proof summary',
      statusFailed: 'Failed to load attestation collector status',
      actionFailed: 'Attestation collector action failed',
      sessionFailed: 'Failed to create attestation capture session',
      copied: 'Collector header copied',
      copyFailed: 'Copy failed'
    },
}
