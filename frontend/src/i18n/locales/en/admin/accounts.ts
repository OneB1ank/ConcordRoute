...
// Accounts
    accounts: {
      ...
      openai: {
        ...
        codexQuotaOverdraftDesc: 'Off by default. The OAuth account ignores reserve thresholds. Normal requests remain unchanged below an exact upstream value of 99.5%; bounded real probes start at 99.5% and reuse the same UA, TLS profile, and account proxy egress. An explicit quota-exhaustion 429 also starts the probe immediately.',
