...
// Accounts Management
    accounts: {
      ...
      openai: {
        ...
        codexTurnMode: 'Turn 处理',
        codexTurnPassthrough: '默认 Turn 透传',
        codexTurnConverge: 'Turn 收敛（实验）',
        codexTurnModeDesc: '仅控制 Cockpit 的 turn_id、parent_turn_id、root_turn_id。默认保留客户端原值；实验模式使用稳定映射，缺失字段不补造。切换后从新请求生效，现有 WebSocket 连接需重连。',
