...
// Usage
  usage: {
    ...
    upstreamStatus: '上游状态',
    upstreamStatusHint: '最终上游 HTTP 响应的实测状态码；200、290、292、312 均不用于判定模型能力、降级或会话健康。不是客户端收到的状态码。',
    upstreamStatusMissingHint: '历史记录、无逐请求 HTTP 响应的 WebSocket 或未接入路径未采集；不按 200 补值。',
    codexTurnStateHint: '仅记录响应头 x-codex-turn-state 去除外侧空白后的字节数。不是 HTTP 状态、有效期或设备证明；不保存原文。',
